...
(setq org-capture-templates
      (quote (("t" "todo" entry (file 'capture-file-path)
              ...
              ("m" "Meeting" entry (file+headline (concat org-work-directory "meetings.org") "Meetings")
               "* %? %U\n" :clock-in t :clock-resume t)
              ("n" "note" entry (file+olp+datetree (concat org-base-directory "notes.org"))
               "* %? :NOTE:\n%U\n%a\n" :clock-in t :clock-resume t)
              ("j" "Journal" entry (file+olp+datetree (concat org-base-directory "diary.org"))
               "* %?\n%U\n" :clock-in t :clock-resume t)
...
(ignore-errors (ido-mode (quote both)))
